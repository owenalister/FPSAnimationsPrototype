...
#define ORIGINAL_FILE_NAME "UE4Editor-AnimStarterPack.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME AnimStarterPack
...
#define ANIMSTARTERPACK_API DLLEXPORT
